# TASKS — HISTORICO (hasta 2026-09-16)

**Esto es el archivo muerto de `docs/TASKS.md`.** Se partio en la spec 0066 (ADR 0069), cuando el
archivo vivo llego a **7.244 lineas / 712 KB** y dejo de cumplir su unico trabajo: ser el punto de
retorno que una sesion fresca lee primero. Desde entonces `docs/TASKS.md` contiene **solo el arco
en ejecucion**, lo diferido vive en `docs/PARQUEADO.md`, y esto —el relato completo de cada sesion,
cada veredicto de revisor, cada tabla de mutaciones— queda aca para consulta.

**No se borro nada:** son las lineas 43 a 7.227 del archivo original, verbatim. Lo unico que quedo
en el archivo vivo es la cabecera y el arco en curso.

Para buscar aca: `grep -n` con el numero de spec o el nombre de la fase.
