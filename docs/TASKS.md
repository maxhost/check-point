...
**Ajuste de QA (`b58f8c8`):** Ayuda tiene 18 px de separación respecto de Carga inteligente,
pusheado a `origin/main`. Medido en navegador a 390 y 1280 px, PASS independiente y seis
gates root verdes (1789 tests passed / 595 skipped; navegador 21 passed / 3 skipped).
