...
Ultima actualizacion: 2026-08-14 (spec 0036 mecánica de acumulación + premios: **IMPLEMENTADA con PASS de revisor independiente**; migración `0019` aplicada y verificada en prod; pusheada a `main`. Único residual: QA manual del owner en vivo. Desbloquea la spec 0030. Catálogo 0034/0035 implementado, migraciones 0017/0018 en prod).
