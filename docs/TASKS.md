...
| 17 | Implementar búsqueda y procedencia de locales | 0023 | en revisión | Geoapify principal y fallback Mapbox implementados; migración 0003 generada. Pendientes aplicar en Neon, configurar claves Geoapify, QA real/E2E y PASS independiente |
