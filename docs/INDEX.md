...
| 0037 | 2026-08-15 | Web Push (notificaciones de navegador, **solo Android**): 2º transporte junto al pase (ADR 0038) para dar notificación de contenido controlado donde el pase de Google muestra banner genérico; `web_push_subscription` + canal `webpush` + service worker + VAPID + fan-out del transaccional; transporte provisionado para que las campañas elijan wallet/browser | borrador | no | `specs/0037-web-push-notificaciones-android.md` |
