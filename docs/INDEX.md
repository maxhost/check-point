...
| 0030 | 2026-08-14 | Acreditación en mostrador: consola web móvil (URL backoffice, cámara) que escanea el QR, auto-enrola y acredita puntos/sellos por venta detallada (carrito) o rápida (importe+nota) — saldo por membresía + orden/ledger owner-facing, atómico e idempotente; **solo acreditación** (el canje es otra feature) | cerrada | no | `specs/0030-acreditacion-en-mostrador.md` |
