...
| 0031 | 2026-08-14 | Micro-portal del consumidor estilo iOS (único acceso hoy: agregar a inicio): nav inferior de 2 pestañas — Programas (tarjeta brandeada por membresía, orden por última actividad, filtro cerrados/inactivos, ícono info→T&C) y Mi QR (con PushPrompt); Mi QR primero hasta confirmar notificaciones. Reencuadrada 2026-08-16, la notificación en vivo ya la cubre 0030/0033/0038/0040 | cerrada | sí | `specs/0031-notificacion-y-landing-en-vivo.md` |
